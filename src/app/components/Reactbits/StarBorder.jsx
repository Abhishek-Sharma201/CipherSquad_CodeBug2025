const StarBorder = ({
    ...
    return (
        <Component
            className={`relative inline-block py-[1px] overflow-hidden cursor-pointer rounded-[20px] ${className}`}
            {...rest}
        >
            {/* Bottom animation */}
            <div
                className="absolute w-[500%] h-[50%] opacity-100 bottom-[-10px] right-[-250%] rounded-full animate-star-movement-bottom z-0"
                style={{
